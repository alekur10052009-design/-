...
while running:
    ...
    s = pygame.Surface((794, 1123), pygame.SRCALPHA)
    pygame.draw.ellipse(s, (0,34,43), (287,1004,30,9)) 
    pygame.draw.polygon(s, (0, 204, 255), [(310,1023),(310,965),(371, 965), (371,929), (537,929), (537,965), (644,965), (644,1023)])
    pygame.draw.polygon(s, (213, 246, 255), [(385,938),(438, 938),(438, 967), (385,967)])
    pygame.draw.polygon(s, (213, 246, 255), [(470,936),(519, 936),(519, 964), (470,964)])
    pygame.draw.ellipse(s, (0,34,43), (335,995,67,48)) 
    pygame.draw.ellipse(s, (0,34,43), (561,994,67,48)) 
    pygame.draw.ellipse(screen, (168,186,186), (166,277,800,180))
    screen.blit(s, (mouse_x-600,mouse_y-1050))
